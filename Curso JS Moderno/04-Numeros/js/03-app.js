...
resultado = Math.PI;
// redondeo
resultado = Math.round(2.5);       //con ceil rediondea hacia arriba y con floor redondea hacia abajo
// redondeo abajo o arriba (ceil o floor )
resultado = Math.ceil(2.2);
// Raiz cuadrada
resultado = Math.sqrt(144);
// Abssoluto
resultado = Math.abs(-300); //valor absoluto 300
// Potencia
resultado = Math.pow(8, 3); //base y altura en este caso 8 a la 3  (8*8*8)
// Minimo
